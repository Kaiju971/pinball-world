...
export const pinballData : Record < PinballKey,
  PinballConfig> = {AiRobot: pinballDataAiRobot,
  ...
  export type {Collider,PinballConfig, LightElement,PinballKey} from './pinballTypes'
