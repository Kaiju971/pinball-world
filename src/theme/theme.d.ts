...
declare module "@mui/material/styles" {
  interface Palette {
    ...
    vertTopBar: Palette["primary"];
    colorMarron: Palette["primary"];
    colorGrisFoncé: Palette["primary"];
    colorGris: Palette["primary"];
    colorTextVert: Palette["primary"];
    LinearColorAccueil: Palette["primary"];
    backgroundAccueil: Palette["primary"];
  }
  ...
  interface PaletteOptions {
    ...
    vertTopBar?: PaletteOptions["primary"];
    gradient1?: PaletteOptions["primary"];
    textGris?: PaletteOptions["primary"];
    colorMarron?: PaletteOptions["primary"];
    colorGrisFoncé?: PaletteOptions["primary"];
    colorTextVert?: PaletteOptions["primary"];
    LinearColorAccueil?: PaletteOptions["primary"];
    backgroundAccueil?: PaletteOptions["primary"];
  }
}
