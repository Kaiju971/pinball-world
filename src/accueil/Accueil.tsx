...
//   const onSelectTable = (url: string) => {
//     setLoadingTable(url);
//     setTimeout(() => {
//       navigate(`/pinball/${url}`);
//     }, 1200); // effet loading type Amiga
//   };
...
//       <S.GridContainer>
//         {itemData.map((item) => (
//           <S.GridItem key={item.title} onClick={() => onSelectTable(item.url)}>
//             <img src={item.img} alt={item.title} />
//           </S.GridItem>
//         ))}
//       </S.GridContainer>
